...
// Update banner background reference
const bannerBg = "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/bannerbg-b5n3jTEUyM78gQiyO488WPiNsGuubn.webp" // Update banner background URL
