...
const NavBar: React.FC = () => {
  ...
  const CustomNavLink: React.FC<CustomNavLinkProps> = ({ link, children, linkEn }) => {
    ...
    const linkClasses = isLinkActive ? "transition-all duration-200 relative" : "opacity-20 transition-all duration-700"

    const leftArrow = isLinkActive && <span className="text-[--orange] absolute -left-5 top-0 max-lg:hidden">&lt;</span>
