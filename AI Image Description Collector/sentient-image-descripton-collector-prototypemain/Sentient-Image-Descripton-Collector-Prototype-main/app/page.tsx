    ...
    <>
      <div
        className={clsx(
          ...
          {
            "border-gray-200 dark:border-gray-800 hover:border-gray-300 dark:hover:border-gray-700": !isDraggingOver,
        ...
        >
          {isLoading ? (
            ...
            <>
              ...
              <p className="hidden [@media(hover:hover)]:block">Drop or paste anywhere, or click to upload.</p>
              ...
              <p className="text-sm mt-3 text-gray-700 dark:text-gray-300">(images are not stored)</p>
            </>
          )}
        </div>
...
function Section({
  ...
  return (
    <div>
      ...
      {finished && !content && (
        <p className="text-gray-600 dark:text-gray-400 select-none">No text was found in that image.</p>
      )}
    </div>
  )
}
